        ...
        >
          ...
          >
            ...
            {user && user?.accountType !== ACCOUNT_TYPE.INSTRUCTOR && (
              <Link
                to="/dashboard/cart"
                className="relative flex items-center text-richblack-5 gap-3 self-start ml-9"
              >
            ...
            {token !== null && (
              <div
                ...
                className="flex items-center text-sm text-richblack-100 hover:bg-richblack-700 hover:text-richblack-25 gap-3 self-start ml-9 font-bold"
              >
          ...
          <div className="w-full h-[1.5px] bg-richblack-5 my-5"></div>
          ...
          {location.pathname.split("/").includes("dashboard") && (
            <>
              <div className="overflow-hidden">
                ...
                >
                  <p className="text-lg text-richblack-5 font-bold mx-3 my-2 ml-14">
                    Dashboard
                  </p>
                  <BsChevronDown
                    className={`${
                    ...
                    <p
                      className={`${
                        matchRoute(link?.path)
                          ? "text-yellow-25"
                          : "text-richblack-100"
                      } flex gap-1 justify-center items-center text-center mr-4`}
                    >
                      {link.icon}
                      {link.title}
                    </p>
